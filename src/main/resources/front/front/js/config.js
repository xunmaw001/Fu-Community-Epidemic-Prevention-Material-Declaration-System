...
var indexNav = [
    ...
    {
        name: '工作分配',
        url: './pages/gongzuofenpei/list.html'
    },
    {
        name: '通知公告',
    ...
    {
        name: '社区人员',
        url: './pages/shequrenyuan/list.html'
    },
    {
        name: '物资',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/shequfywzshenbao/admin/dist/index.html#/login";
