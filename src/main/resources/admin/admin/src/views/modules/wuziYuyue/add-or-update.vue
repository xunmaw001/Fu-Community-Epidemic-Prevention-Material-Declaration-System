    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='wuzi' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.wuziPhoto" label="物资图片" prop="wuziPhoto">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziPhoto" label="物资图片" prop="wuziPhoto">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请数量" prop="wuziYuyueNumber">
                       <el-input v-model="ruleForm.wuziYuyueNumber"
                                 placeholder="申请数量" clearable  :readonly="ro.wuziYuyueNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="申请数量" prop="wuziYuyueNumber">
                           <el-input v-model="ruleForm.wuziYuyueNumber"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziYuyueYesnoTypes" label="申请状态" prop="wuziYuyueYesnoTypes">
                        <el-input v-model="ruleForm.wuziYuyueYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziYuyueYesnoText" label="申请结果" prop="wuziYuyueYesnoText">
                        <span v-html="ruleForm.wuziYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    wuziId: false,
                    yonghuId: false,
                    wuziYuyueNumber: false,
                    wuziYuyueYesnoTypes: false,
                    wuziYuyueYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    wuziId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wuzi_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.wuziYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`wuziYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.wuziYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
